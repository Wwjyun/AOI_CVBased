...
- [x] 2026-06-25 Matrix summary exporter outputs id-first rows, stable prefix sorting, and numeric NG marks
...
- [x] 2026-06-30 Changed Detector900 to use outer/inner width-height filtering only, removing area limits
